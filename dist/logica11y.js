...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    function s(o, u) {
      ...
      module.exports = function (el, attrs) {
        ...
        attrs.forEach(function (attr) {
          ...
          if (!!actual && !attr.value) {
            return;
          } // valid. element has the attribute (any value is allowed).
       ...
       */
      module.exports = function (target, which, qualify) {
        var qualified = false;

        keyTypes.forEach(function (eventType) {
          if (qualified) {
            return;
          }
          var thisEvent = new Event(eventType);
      ...
      var mouseTypes = ['mousedown', 'mouseup', 'click'];
       ...
       */
      module.exports = function (data, qualify, timeout) {
        return new Promise(function (resolve, reject) {
          ...
          function fireEvents() {
            ...
            mouseTypes.forEach(function (eventType) {
      ...
      var mouseVents = require('../commons/events/mouse');
      var isVisible = require('axe-core').commons.dom.isVisible;
      var getPanel = function getPanel(t) {
        return document.getElementById(t.id || '');
      };

      module.exports = function (tabs, timeout) {
        var result = { passes: [], failures: [] };
        return new Promise(function (resolve, reject) {
          var ariaSelectedFailed = false;
          var pairs = tabs.map(function (tab) {
            return { tab: tab, panel: getPanel(tab) };
          });

          // mouse activation / aria-selected stuff
          mouseVents(pairs, function (data) {
            var fails = pairs.filter(function (pair) {
              var val = pair.tab === data.tab ? 'true' : 'false';
              return pair.tab.getAttribute('aria-selected') === val;
            });
            if (fails.length) {
              ariaSelectedFailed = true;
            }

            return data.panel && isVisible(data.panel);
          }, timeout).then(function (qualified) {
            // activation
    ...
    }, { "../commons/events/mouse": 3, "axe-core": 8 }], 5: [function (require, module, exports) {
      'use strict';

      var keyVent = require('../commons/events/keyboard');
      ...
      module.exports = function (tabs) {
        ...
        // first => second
        var doesFocusNext = keyVent(first, 39, function () {
        ...
        // second => first
        second.focus();
        var doesFocusPrev = keyVent(second, 37, function () {
    ...
    }, { "../commons/events/keyboard": 2 }], 6: [function (require, module, exports) {
      'use strict';
       ...
       *   timeout: 750 // time it takes for animation / display change to take place (activation)
      ...
      module.exports = function (opts) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          var arrowResults = arrows(tabs);
          arrowResults.failures.forEach(function (fail) {
            return result(false, fail);
          });
          arrowResults.passes.forEach(function (pass) {
            return result(true, pass);
          });

          activate(tabs, opts.timeout || 0).then(function (res) {
    ...
    }, { "../commons/attributes": 1, "./activate": 4, "./arrows": 5, "closest": 9 }], 7: [function (require, module, exports) {
    ...
    }, { "./lib/tabs": 6 }], 8: [function (require, module, exports) {
      /*! aXe v2.1.7
        ...
        */
        ...
        axe._load({
          ...
          checks: [{
            ...
            id: 'multiple-label',
            evaluate: function evaluate(node, options) {
              var labels = [].slice.call(document.querySelectorAll('label[for="' + axe.commons.utils.escapeSelector(node.id) + '"]')),
