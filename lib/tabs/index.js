...
module.exports = (opts) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    const arrowResults = arrows(tabs);
    arrowResults.failures.forEach((fail) => result(false, fail));
    arrowResults.passes.forEach((pass) => result(true, pass));

    activate(tabs, opts.timeout || 0)
      .then((res) => {
